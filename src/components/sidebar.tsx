...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="w-64 bg-white text-gray-900 fixed h-screen p-4">
                  ...
                  <Link
                    className={`${
                      isActive(eachItem.href)
                        ? "flex items-center px-4 py-2 m-5 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200"
                        : "flex items-center px-4 py-2 m-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    }`}
                    href={eachItem.href}
                  >
                    {eachItem.icon}
